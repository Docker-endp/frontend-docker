...
var searchInput = document.getElementById('datos-busqueda');
var searchResults = document.getElementById('result-busqueda');
...
searchInput.addEventListener('keypress', function (event) {
  if (event.key === 'Enter') {
    var query = searchInput.value.trim(); // Obtener el texto de búsqueda sin espacios al inicio y al final
    if (query !== '') {
      searchResults.innerHTML = "Buscando resultados para: <strong>".concat(query, "</strong>");
    } else {
      var mensaje = 'Por favor ingresa un término de búsqueda.';
